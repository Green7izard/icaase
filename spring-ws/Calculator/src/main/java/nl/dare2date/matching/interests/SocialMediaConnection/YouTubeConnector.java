...
approval_prompt=force
    ...
    private static final String AUTH_TOKEN_MARK = "${AUTH_TOKEN}";
    ...
    private static final String GET_CATEGORY = YOUTUBE_URL+"https://www.googleapis.com/youtube/v3/guideCategories?part=snippet&id="+ID_MARK+"&key="+GOOGLE_ID;
